...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>BIENVENUE SUR VOTRE E-BUREAU</title>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="j_security_check" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="j_username" id="username" type="text" placeholder="Nom d'utilisateur"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="j_password" id="password" type="password" placeholder="Mot de passe"/>
							</div>
							<div class="clearfix"></div>
					...
					<p>
						Pas de problem, <a href="#">cliquez ici</a> pour avoir un nouveau mot de passe.
					</p>	
				</div><!--/span-->
			</div><!--/row-->
